...
assert_manifest_contract() {
  ...
  printf '%s\n' "${manifest}" | jq -e '
    ...
    and (.modes.discovery.evidence_capabilities == ["filesystem.list_tree", "filesystem.search_symbol", "runtime.read_target_system_profile", "runtime.read_epistemic_handover"])
    and (.modes.forensics.evidence_capabilities == ["filesystem.search_symbol", "git.status", "runtime.read_target_system_profile", "runtime.read_epistemic_handover"])
    and (.modes.validation.evidence_capabilities == ["runtime.read_target_system_profile", "runtime.read_epistemic_handover"])
    and (.modes.adversarial.evidence_capabilities == ["filesystem.search_symbol", "runtime.read_target_system_profile"])
...
main() {
  ...
  assert_mode_output "validation" '["runtime_read_target_system_profile.json", "runtime_read_epistemic_handover.json"]'
  assert_mode_output "adversarial" '["filesystem_search_symbol.json", "runtime_read_target_system_profile.json"]'

  assert_materialized_runtime_state \
    "discovery" \
    '["filesystem_list_tree.json", "filesystem_search_symbol.json", "runtime_read_epistemic_handover.json", "runtime_read_target_system_profile.json"]'

  assert_materialized_runtime_state \
    "forensics" \
    '["filesystem_search_symbol.json", "git_status.json", "runtime_read_epistemic_handover.json", "runtime_read_target_system_profile.json"]'
